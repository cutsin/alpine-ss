...
acme.sh --upgrade --auto-upgrade --force
acme.sh --installcert -d $YOURDOMAIN --cert-file /srv/ssl/cert --key-file /srv/ssl/key --ca-file /srv/ssl/ca --fullchain-file /srv/ssl/fullchain --reloadcmd "sudo reboot -f" --ecc --force
